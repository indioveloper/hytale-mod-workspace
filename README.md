...
| `mods/java/more-triggers` | Activo/prototipo, v1.10.0 | Utilidades generales de Trigger Volumes, incluida la regla `NoMove`, `ExecuteCommand`, objetos aleatorios filtrados, mensajes con tags, timer circular y senales repetitivas persistentes. |
...
(`f0a85f20ac60b34232fa6b42d3585850bd959dde`); More Triggers 1.10.0 ya se
