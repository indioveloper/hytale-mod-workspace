...
| `mods/java/more-triggers` | Activo, v1.1.0 | Efectos para pegar un prefab aleatorio, elegir tags aleatorios y ocultar titulos de evento. |
...
Los snapshots restaurables de partidas se guardan en `snapshots/`. Estos son
excepciones deliberadas a la regla general de no versionar saves y usan Git LFS
para los ZIP grandes.
