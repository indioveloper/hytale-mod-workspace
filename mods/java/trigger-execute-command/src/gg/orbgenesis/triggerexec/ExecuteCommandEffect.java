...
public class ExecuteCommandEffect extends TriggerEffect {
  ...
  public void execute(TriggerContext context) {
    ...
    ExecutorMode executorMode = this.executor != null ? this.executor : ExecutorMode.SERVER;
  ...
  private boolean shouldRunAsPlayer(ExecutorMode executorMode) {
    return executorMode == ExecutorMode.PLAYER;
  }
