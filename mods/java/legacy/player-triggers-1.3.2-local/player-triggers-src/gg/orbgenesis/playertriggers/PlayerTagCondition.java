...
public class PlayerTagCondition extends TriggerCondition {
  ...
  public static final BuilderCodec<PlayerTagCondition> CODEC =
      BuilderCodec.builder(
              PlayerTagCondition.class,
              PlayerTagCondition::new,
              TriggerCondition.BASE_CODEC)
          .append(
              new KeyedCodec<>("Tag", Codec.STRING),
              (condition, value) -> condition.tag = value,
              condition -> condition.tag)
          .add()
          .append(
              new KeyedCodec<>("Comparison", new EnumCodec<>(Comparison.class)),
  ...
  public boolean test(TriggerContext context) {
    ...
    Map<String, String> tags =
        component == null ? Map.of() : component.getTags();
    ...
    return switch (comparison) {
      case EXISTS -> exists;
      case MISSING -> !exists;
      case EQUALS -> exists && equalsValue(actual, value);
      case NOT_EQUALS -> !exists || !equalsValue(actual, value);
      case GREATER_THAN -> compareNumbers(actual, value, Comparison.GREATER_THAN);
      case GREATER_OR_EQUAL ->
          compareNumbers(actual, value, Comparison.GREATER_OR_EQUAL);
      case LESS_THAN -> compareNumbers(actual, value, Comparison.LESS_THAN);
      case LESS_OR_EQUAL ->
          compareNumbers(actual, value, Comparison.LESS_OR_EQUAL);
    };
  }
