...
public class PlayerCountHudEffect extends TriggerEffect {
  public enum Mode {
    SHOW,
    HIDE,
    TOGGLE
  ...
  public static final BuilderCodec<PlayerCountHudEffect> CODEC =
      BuilderCodec.builder(
              PlayerCountHudEffect.class,
              PlayerCountHudEffect::new,
  ...
  public void execute(TriggerContext context) {
    ...
    boolean enabled =
        switch (mode) {
          case SHOW -> true;
          case HIDE -> false;
          case TOGGLE -> !component.isPlayerCountHudEnabled();
        };
    component.setPlayerCountHudEnabled(enabled);
  ...
  private void updateHud(
    ...
    if (!enabled) {
      PlayerCountHud.remove(player, playerRef);
      return;
    }

    PlayerCountHud.getOrCreate(player, playerRef)
        .updateCount(
            component
                .getTags()
                .getOrDefault(PlayerCountTagSystem.PLAYERS_ONLINE_TAG, "0"));
  }
}
