...
public class RandomTagSelectionEffect extends TriggerEffect {
  public static final BuilderCodec<RandomTagSelectionEffect> CODEC =
      BuilderCodec.builder(
          ...
          .append(
              new KeyedCodec<>(
                  "Center", new EnumCodec<>(TaggedVolumeEffectUtil.Center.class), false),
  ...
  public void execute(TriggerContext context) {
    if (context.getStore() == null || tagKey == null || tagKey.isBlank()) {
      return;
    }
    ...
    List<String> values = parseList(tagValues);
    if (values.isEmpty()) {
      return;
    }
  ...
  static List<String> parseList(String rawValues) {
