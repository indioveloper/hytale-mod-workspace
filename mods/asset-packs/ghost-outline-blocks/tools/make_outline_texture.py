...
def make_outline(source: Path, output: Path, border: int, alpha: int) -> None:
    ...
    for y in range(height):
        for x in range(width):
            ...
            r, g, b, a = pixels[x, y]
            pixels[x, y] = (r, g, b, min(a, alpha) if in_border else 0)
...
def main() -> None:
    ...
    parser.add_argument("--border", type=int, default=4, help="Border thickness in pixels.")
    parser.add_argument("--alpha", type=int, default=190, help="Outline alpha, 0-255.")
